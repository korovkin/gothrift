...
class Processor(Iface, TProcessor):
    ...
    def process_get_name(self, seqid, iprot, oprot):
        ...
        result = get_name_result()
        try:
            result.success = self._handler.get_name()
        ...
        oprot.writeMessageBegin("get_name", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
all_structs.append(get_name_args)
get_name_args.thrift_spec = (
)
...
class get_name_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_name_result)
get_name_result.thrift_spec = (
